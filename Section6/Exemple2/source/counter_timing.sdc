...
# Set Input Delay
#**************************************************************
set_input_delay -add_delay -clock [get_clocks {clock_50}] 0.020 [get_ports {stop}]
...
# Set Output Delay
#**************************************************************
set_output_delay -add_delay -clock [get_clocks {clock_50}] 0.020 [get_ports {led[0]}]
set_output_delay -add_delay -clock [get_clocks {clock_50}] 0.020 [get_ports {led[1]}]
set_output_delay -add_delay -clock [get_clocks {clock_50}] 0.020 [get_ports {led[2]}]
set_output_delay -add_delay -clock [get_clocks {clock_50}] 0.020 [get_ports {led[3]}]
